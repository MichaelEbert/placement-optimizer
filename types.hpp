...
inline void sumAdjacentComponents(cell* thisCell, gsize_t x, gsize_t y, unsigned char* adjComponents);
...
class Component{
public:
	static const void component_setup(cell* thisCell, gsize_t x, gsize_t y){
		return;
	}
};
