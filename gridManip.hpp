...
void increment_grid(thread_grids& tgrids) noexcept;//increment grid. used for brute force search.

void sim(thread_grids& tgrids) noexcept;//sim the grid typegrid 
